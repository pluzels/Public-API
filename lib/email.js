    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs PluzelsNail</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6262626262">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>Pluzels</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Pluzels" <galih@gmail.com>',
        to: email,
        subject: 'Verify Email - Api Pluzels',
        html: inboxGmail,
      };
